...
<style type="text/css"></style>
		<SCRIPT language=javascript>		
			function goToAddProduct(){
			 window.location.href="${ctx}/manage/createProduct.jsp";
			}
		</SCRIPT>
</head>
<body>
...
<div class="content">
  ...
  <div class="main">
    <!--展示信息区 -->
				<div>
					<div id="itemDisplay">
						<center><font style="font-size:16px; color:#006A6A; font-weight:bolder;">产品列表</font></center>
		...
		<table cellSpacing=1 cellPadding=0 width="100%"
			...
			<tr>
				<td width="40">
					<div align="left">
						<input type="button" onclick="goToAddProduct()" value="添加产品" />
					</div>
				</td>
			</tr>
		</table>
...
<th width="250">
				...
				<s:iterator value="productList" status="product">
					<tr align="center">
						...
						<td width="150">
							<s:date format="yyyy-MM-dd" name="publishDate" />
						</td>
						<td width="150">
						...
						<td width="250">
							<a
								href="<s:url action="goEditProductAction"> 
							...
							<a
								href="<s:url action="deleteProductAction"> 
                     			<s:param name="productId"> 
                       			 	<s:property value="id"/> 
                    			</s:param> 
                					</s:url>"
